...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
        ...
        <form class="space-y-6" action="{{ route('signin_function') }}" method="post">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="fullName" name="name"
                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-purple-500 focus:ring-2  focus:border-transparent transition duration-200"
            ...
            <button type="submit"
                class="w-full bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500  focus:ring-offset-2 transition duration-200 font-medium">
                Create Account
            </button>
        </form>
        ...
        <div class="mt-6 text-center">
            <p class="text-gray-600">
                ...
                <a href="{{ route('login') }}"
                    class="text-purple-600 hover:text-purple-800 font-medium underline">login</a>
            </p>
        </div>
        ...
        <div class="mt-6">
            ...
            <div class="mt-6 grid grid-cols-2 gap-3">
                <button type="button"
                    class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
